...
#ifndef SHOREWATCH_SWIFT_H
#define SHOREWATCH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ShoreWatch",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class CLLocation;
SWIFT_CLASS("_TtC10ShoreWatch15LocationManager")
...
@class NSCoder;
SWIFT_CLASS("_TtC10ShoreWatch13PreviewUIView")
